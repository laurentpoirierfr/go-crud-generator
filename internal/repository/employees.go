...
func GetEmployeesByID(db *sql.DB, id int) (*Employees, error) {
...
func UpdateEmployees(db *sql.DB, entity Employees, id int) (sql.Result, error) {
...
func DeleteEmployees(db *sql.DB, id int) (sql.Result, error) {
