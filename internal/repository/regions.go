...
func GetRegionsByID(db *sql.DB, id int) (*Regions, error) {
...
func UpdateRegions(db *sql.DB, entity Regions, id int) (sql.Result, error) {
...
func DeleteRegions(db *sql.DB, id int) (sql.Result, error) {
